            ...
            <Grid item xs={12} sm={6} xl={6}>
              <Box>
                ...
                <Typography
                  ...
                  paragraph
                >
                  This web app was created to help people who are interested in
                  the sport of soccer to meet up with local teams in the area
                ...
                <Grid container spacing={2} align="center">
                  <Grid item xs={12} sm={4}>
                    ...
                    <Typography variant="body1" color="text.secondary">
                      Designed to be responsive. Can work on any desktop or
                      mobile device.
                    </Typography>
                  </Grid>
                  <Grid item xs={12} sm={4}>
                    ...
                    <Typography variant="body1" color="text.secondary">
                      Designed to look modern. Developed using the React and
                      NodeJS frameworks.
                    </Typography>
                  </Grid>
                  <Grid item xs={12} sm={4}>
                    ...
                    <Typography variant="body1" color="text.secondary">
                      Continuous updates. There will be new features added in
                      the future.
                    </Typography>
                  </Grid>
                </Grid>
